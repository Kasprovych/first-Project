	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<div class="row">
					<div class="col-md-12 col-xs-12">
						<form:form class="form-horizontal" action="/admin/size"
							method="POST" modelAttribute="size">
							<div class="form-group">
								<div class="form-group">
									<label for="length" class="col-sm-offset-3 col-sm-9"><form:errors
											path="length" /></label>
								</div>
							...
							<div class="form-group">
								<div class="form-group">
									<label for="width" class="col-sm-offset-3 col-sm-9"><form:errors
											path="width" /></label>
								</div>
							...
							<div class="form-group">
								<div class="form-group">
									<label for="height" class="col-sm-offset-3 col-sm-9"><form:errors
											path="height" /></label>
								</div>
		...
		<c:forEach items="${sizes}" var="size">
			<div class="row">
				...
				<div class="col-md-2 col-xs-2">
					<a class="btn btn-warning" href="/admin/size/update/${size.id}">update</a>
				</div>
				<div class="col-md-2 col-xs-2">
					<a class="btn btn-danger" href="/admin/size/delete/${size.id}">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
